...
class _PlandetailsState extends State<Plandetails> with TickerProviderStateMixin{

static AnimationController card_cont_1 , card_cont_2, card_cont_3, card_cont_4, card_cont_5;
...
curve1 = CurvedAnimation(parent: card_cont_1, curve: Curves.fastLinearToSlowEaseIn);
curve2 = CurvedAnimation(parent: card_cont_2, curve: Curves.fastLinearToSlowEaseIn);
curve3 = CurvedAnimation(parent: card_cont_3, curve: Curves.fastLinearToSlowEaseIn);
curve4 = CurvedAnimation(parent: card_cont_4, curve: Curves.fastLinearToSlowEaseIn);
curve5 = CurvedAnimation(parent: card_cont_5, curve: Curves.fastLinearToSlowEaseIn);
